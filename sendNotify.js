...
function pushPlusNotify(text, desp) {
  try {
    ...
    const pushplusnotifyList = process.env.NOTIFY_PUSHPLUS_LIST ?     process.env.NOTIFY_PUSHPLUS_LIST.split('&') : [];
    const titleIndex = pushplusnotifyList.findIndex((item) => item === text);
